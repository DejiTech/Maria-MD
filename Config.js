...
//contact details
global.ownernumber = [ process.env.OWNER_NUMBER || "8103947720"],
global.ownername = process.env.OWNER_NAME || "DejiTech",
global.ytname = "YT: DejiTech.inc"
global.socialm = "GitHub: DejiTech"
global.location = "Nigerian"

global.botname = process.env.BOTNAME || "DejiTech",//name of the bot

//sticker details
global.stickername = process.env.STICKER || "💙𓆩‎✘AʏᴜSʜ✘𓆪_✰",
global.packname = 'Sticker By'
global.author = process.env.AUTHOR || "DejiTech",
//console view/theme
global.themeemoji = '🧩'
global.wm = "Deji botz inc."
